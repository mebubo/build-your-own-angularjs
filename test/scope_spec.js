...
describe('Scope', function() {
  ...
  describe('digest', function() {
    ...
    it('catches exceptions in watch functions and countinues', function() {
      scope.aValue = 'abc';
      scope.counter = 0;
  ...
  describe('$watchGroup', function() {
    ...
    it('does not call the zero-watch listener when deregistered first', function() {
      ...
      var destroyGroup = scope.$watchGroup([], function() { counter++; });
      destroyGroup();
      scope.$digest();
  ...
  describe('$watchCollection', function() {
    ...
    it('notices when an item is added to an array', function() {
      scope.arr = [1, 2, 3];
      scope.counter = 0;
    ...
    it('notices when an item is removed from an array', function() {
      scope.arr = [1, 2, 3];
      scope.counter = 0;
    ...
    it('notices when the value becoumes an object', function() {
      scope.counter = 0;
    ...
    it('uses the new value as the old value of first digest', function() {
      scope.aValue = {a: 1, b: 2};
      var oldValueGiven;
  ...
  describe('Events', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('passes additional argumants to listeners on ' + method, function() {
        var listener = jasmine.createSpy();
        scope.$on('someEvent', listener);
      ...
      it('sets defalutPrevented whin preventDefault is called on ' + method, () => {
      ...
      it('does not stop on exceptions on ' + method, () => {
        const listener1 = event => { throw 'listener1 throwing an exception' };
    ...
    it('propagates the same evetn up on $emit', function() {
      var parentListener = jasmine.createSpy();
      var scopeListener = jasmine.createSpy();
